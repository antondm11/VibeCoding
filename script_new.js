...
const podiumData = {
    'Tyrrell P34': { podios: 14, carreras: 32 },
    'Brabham BT46B': { podios: 1, carreras: 1 },
    'Tyrrell 019': { podios: 1, carreras: 14 },
    'Modena Lambo 291': { podios: 0, carreras: 2 },
    'Ferrari F92A': { podios: 2, carreras: 14 },
    'Williams FW26': { podios: 4, carreras: 18 },
    'Renault R31': { podios: 2, carreras: 19 },
    'Force India VJM08': { podios: 1, carreras: 19 },
    'Force India VJM09': { podios: 3, carreras: 21 },
    'Mercedes W13': { podios: 17, carreras: 22 }
};
...
function initPodiumChart() {
    ...
    // Preparar datos
    const cars = Object.keys(podiumData);
    const podiums = cars.map(car => podiumData[car].podios);
    
    // Colores del gráfico
    const colors = [
        '#dc0000', '#ff4444', '#ff6b6b', '#ff8787', 
        '#ffa5a5', '#ffb3b3', '#ffcac7', '#ffdddd', '#ffe8e8', '#ffebeb'
    ];
